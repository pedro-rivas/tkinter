...
def tell_status() : 
	...
	result = ["Amigos", "Amor", "Cariño", "Matrimonio", "Enemigo", "Hermanos"] 
...
if __name__ == "__main__" : 
	...
	label1 = Label(root, text = "Nombre de Jugador 1: ", 
				fg = 'black', bg = 'dark green') 
	
	# Create a Player 2 Name: label 
	label2 = Label(root, text = "Nombre de Jugador 2: ", 
				fg = 'black', bg = 'dark green') 
		
	# Create a Relation Status: label 
	label3 = Label(root, text = "Estado de Relación: ", 
				fg = 'black', bg = 'red') 
	...
	button1 = Button(root, text = "Enviar", bg = "red", 
					fg = "black", command = tell_status) 
	
	# Create a Clear Button and attached 
	# to clear_all function 
	button2 = Button(root, text = "Borrar", bg = "red", 
